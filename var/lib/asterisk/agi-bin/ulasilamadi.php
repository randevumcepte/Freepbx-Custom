...
require('phpagi.php');
$agi = new AGI();
$agi->verbose('ulaşılamadı işaretlenecek');

$sonuc = ulasilamadiIsaretle($agi,$argv[1], $argv[2]);
$agi->verbose('json data : ' . json_encode($sonuc, JSON_UNESCAPED_UNICODE));

function ulasilamadiIsaretle($agi,$randevuId, $alacakIdler)
{
    $url = 'https://app.randevumcepte.com.tr/api/v1/asistanUlasamadi';
    ...
    $data = ['randevu_id' => $randevuId, 'alacak_idler' => json_decode($alacakIdler, true)];
