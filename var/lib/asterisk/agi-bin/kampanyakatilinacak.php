...
$sonuc = kampanyaKatilicakKatilmayacakIsaretle($agi,$argv[1],$argv[2]);
...
function kampanyaKatilicakKatilmayacakIsaretle($agi,$katilimciId,$katilacak)
{
    $url = 'https://app.randevumcepte.com.tr/api/v1/kampanyaKatilinacak';

    //  Gönderilen parametreleri logla
    //global $agi;
 
    $data = ['katilimci_id' => $katilimciId,'katilacak'=>$katilacak];
